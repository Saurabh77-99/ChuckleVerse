        ...
        <ul className="flex items-center justify-between h-16">
          ...
          <li className="flex-1">
            <Link
              href="/rankings"
              className={`flex flex-col items-center justify-center h-full ${
                isActive('/rankings') ? 'text-cyan-500' : 'text-[#898989] hover:text-white'
              }`}
            >
              <Trophy size={24} />
          ...
          <li className="flex-1 -mt-8">
            <button
              ...
              className="flex flex-col items-center justify-center w-14 h-14 mx-auto bg-cyan-500 rounded-full text-white shadow-lg transform transition-transform hover:scale-105"
            >
              <Plus size={28} />
            </button>
          </li>
