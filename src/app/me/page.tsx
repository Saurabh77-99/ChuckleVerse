...
export default function MePage() {
  ...
  const fetchPosts = async (page: number) => {
    ...
    try {
      ...
      postsArray = rawPosts
        .filter((post: any) => post && typeof post === 'object') // Ensure post is an object
        .map((post: any) => ({
    ...
    <div className="h-screen flex flex-col overflow-hidden bg-[#1f1f1f]">
      ...
      <AnimatePresence>
        {showScoreNotification && (
          ...
          >
            <div className="bg-cyan-500 text-white px-6 py-4 rounded-lg shadow-xl">
      ...
      <div className="sticky top-0 left-0 right-0 z-10 bg-[#1f1f1f]">
        <div className="relative">
          {/* Background Pattern */}
          <div className="absolute inset-0 h-48 bg-gradient-to-b from-cyan-500/20 to-transparent" />
            ...
            {user && (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-cyan-400">HEHE Score: {user.heheScore}</p>
                </div>
                ...
                <div className="flex space-x-4 border-b border-[#2f2f2f]">
                  <button
                    ...
                    className={`pb-2 px-1 text-sm font-medium transition-colors relative ${
                      activeTab === 'posts' ? 'text-cyan-500' : 'text-gray-400'
                    }`}
                  >
                    Posts
                    {activeTab === 'posts' && (
                  ...
                  <button
                    ...
                    className={`pb-2 px-1 text-sm font-medium transition-colors relative ${
                      activeTab === 'nfts' ? 'text-cyan-500' : 'text-gray-400'
                    }`}
                  >
                    NFTs
                    {activeTab === 'nfts' && (
                  ...
                  <button
                    ...
                    className={`pb-2 px-1 text-sm font-medium transition-colors relative ${
                      activeTab === 'liked' ? 'text-cyan-500' : 'text-gray-400'
                    }`}
                  >
                    Liked
                    {activeTab === 'liked' && (
                ...
                nfts.map((nft) => (
                  ...
                  >
                    <div className="relative rounded-xl overflow-hidden aspect-square">
                      ...
                      />
                      {nft.burnEligible && (
                        <div className="absolute inset-0 border-[4px] border-cyan-500 rounded-xl glow-cyan"></div>
                      )}
                      {burningNftId === nft.tokenId && (
                        <motion.div
                          className="absolute inset-0 bg-gradient-to-t from-cyan-500/80 via-cyan-400/50 to-transparent mix-blend-overlay"
                          initial={{ opacity: 0 }}
                          animate={{ 
                            opacity: [0, 0.8, 1],
                            scale: [1, 1.2, 1.5]
                        ...
                        >
                          <div className="absolute inset-0 animate-pulse bg-gradient-to-t from-cyan-300 via-cyan-500 to-transparent"></div>
                        </motion.div>
                      )}
                    ...
                    {nft.burnEligible && (
                      <button
                        ...
                        className="absolute bottom-2 right-2 bg-cyan-500 text-white px-3 py-1 rounded-full text-sm font-medium hover:bg-cyan-600 transition-colors  disabled:cursor-not-allowed flex items-center gap-2"
                      >
