        ...
        {showUsernameForm ? (
          <form onSubmit={handleSubmitUsername} className="space-y-4">
            <input
              ...
              className="w-full px-4 py-2 rounded bg-gray-800 text-white border border-gray-700 focus:outline-none focus:border-cyan-500"
              disabled={isAuthenticating}
            />
            <button
              type="submit"
              className="w-full bg-cyan-500 text-white py-2 px-4 rounded hover:bg-cyan-600 transition-colors disabled:opacity-50"
